...
func checkRecordsForFlows(t *testing.T, data *TestData, srcIP string, dstIP string, isIPv6 bool, isIntraNode bool, checkService bool, checkK8sNetworkPolicy bool, checkAntreaNetworkPolicy bool) {
	...
	checkRecordsForFlowsCollector(t, srcIP, dstIP, srcPort, isIPv6, isIntraNode, checkService, checkK8sNetworkPolicy, checkAntreaNetworkPolicy, bandwidthInMbps)
...
func checkRecordsForFlowsCollector(t *testing.T, srcIP, dstIP, srcPort string, isIPv6, isIntraNode, checkService, checkK8sNetworkPolicy, checkAntreaNetworkPolicy bool, bandwidthInMbps float64) {
...
func checkRecordsForDenyFlows(t *testing.T, data *TestData, testFlow1, testFlow2 testFlow, isIPv6, isIntraNode, isANP bool) {
	...
	checkRecordsForDenyFlowsCollector(t, testFlow1, testFlow2, isIPv6, isIntraNode, isANP)
	checkRecordsForDenyFlowsClickHouse(t, data, testFlow1, testFlow2, isIPv6, isIntraNode, isANP)
}

func checkRecordsForDenyFlowsCollector(t *testing.T, testFlow1, testFlow2 testFlow, isIPv6, isIntraNode, isANP bool) {
